    ...
    <div id="shell">
        ...
        <a href="#/product" @click="gettype">
            <div class="phone" id="img1">
                <img src="../../../hammer-img/30.png" alt="" style="width:100%">
            </div>
        </a>
            ...
            <ul id="oul">
                <a href="#/detail" @click="getname">
                    <li class="bord-b bord-r oli">
                        <p>
                            <span class="name-z">《老人与海》  </span> <i class="iconfont icon--youjiantou"></i>
                        </p>
                    </li>
                </a>
                <a href="#/detail" @click="getname">
...
<style scoped>
    ...
    #oul  li > p{
        background:url("../../../hammer-img/20.jpg") no-repeat left top;
