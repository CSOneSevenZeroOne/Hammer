<template>
    <div id="air">
        <div class="phone">
            <p id="p1" v-text="type"></p>
        </div>

        <a href="#/product" @click="gettype">
            <div class="phone" id="img1">
                <img src="../../../hammer-img/4.png" alt="" style="width:100%">
            </div>
        </a>
        ...
        <div class="myul">
            <ul id="oul">
                <a href="#/detail" @click="getname">
                    <li class="bord-b bord-r oli">
                        <p>
                            <span class="name-z">畅呼吸防护口罩  </span> <i class="iconfont icon--youjiantou"></i>
                        </p>
                    </li>
                </a>
        ...
        methods : {
            ...
            getname(event){
                ...
                if(bflg){
                    ...
                    this.$store.state.name = $(event.target).parents(".oli").find(".name-z").text().trim()
                }
...
<style scoped>
    ...
    #oul li > p{
        background:url("../../../hammer-img/24.jpg") no-repeat left top;
